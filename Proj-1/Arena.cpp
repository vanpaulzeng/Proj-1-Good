...
#include <stdio.h>
// iostream include will fix the endl error, "Use of undeclared identifier 'exit'"
#include <iostream>
// Next using std will fix , Unknown type name 'string'
//using namespace std;
...
: m_previous(nRows, nCols)  //initializer list, instance for the Previous within Arena initialization, this wil make an object and named as m_previous
{
...
bool Arena::addPlayer(int r, int c)
{
    ...
    // aaa cross reference Previous since it need to know the visiting

    //aaa need add 1 visit here
    return true;
}
...
//Also need to add this funtion to return m_previous
